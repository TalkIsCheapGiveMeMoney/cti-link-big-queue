...
@Component
public class UnconsultHandler implements EventHandler, InitializingBean{
	...
	public void afterPropertiesSet() throws Exception{
		EventHandlerFactory.register(AmiEventTypeConst.UNCONSULT, this);
	}
			...
			if(memberLock != null){
				try{
					...
					if(callAgent != null){
						...
						callAgent.setConsultLocalChannel("");
